...
std::vector<std::string> vkInit::log_transform_bits(const vk::SurfaceTransformFlagsKHR& bits)
{
...
std::vector<std::string> vkInit::log_alpha_composite_bits(const vk::CompositeAlphaFlagsKHR& bits)
{
	std::vector<std::string> result;
...
std::vector<std::string> vkInit::log_image_usage_bits(const vk::ImageUsageFlags& bits)
{
	std::vector<std::string> result;
...
std::string vkInit::log_present_mode(const vk::PresentModeKHR& presentMode)
{
